    ...
    function Grid(options) {
        ...
        this.connect = function (container) {
            if (container) {
                ...
                var mutationObserver_1 = new observer_1.ChildListMutationObserver(digest_1);
                // add requestAnimationFrame to smooth digest
                var smoothDigest = function () {
                    requestAnimationFrame(function () {
                        digest_1();
                    });
                };
                var resizeObserver_1 = new resize_observer_1.ResizeObserver(smoothDigest);
                var dispose_1 = (0, reactive_1.reaction)(function () { return (__assign({}, _this.options)); }, digest_1);
