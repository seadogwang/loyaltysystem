...
FormButtonGroup.Sticky = function (_a) {
    ...
    var ref = useRef(null);
    var _c = __read(useState('transparent'), 2), color = _c[0], setColor = _c[1];
    var prefixCls = usePrefixCls('formily-button-group');
    ...
    return wrapSSR(React.createElement(StickyBox, __assign({}, props, { className: cls("".concat(prefixCls, "-sticky"), hashId, props.className), style: __assign({ backgroundColor: color }, props.style), bottom: true }),
