 ...
 * @returns 完整的字段值集合
 */
declare const completedKeys: (flatDataSource: any[] | undefined, selected: any[], primaryKey?: string) => any[];
/**
 ...
 */
declare const getOutputData: (keys: any[], options: any[], dataSource: any[] | undefined, primaryKey: string | undefined, originalValueType: string | undefined, originalOptionAsValue: boolean | undefined, mode: string | undefined, checkStrictly: boolean | undefined) => {
    outputValue: any[];
    outputOptions: any[];
};
/**
