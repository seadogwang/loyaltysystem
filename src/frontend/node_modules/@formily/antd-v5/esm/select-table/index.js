...
var addPrimaryKey = function (dataSource, rowKey, primaryKey) {
    return dataSource.map(function (item) {
        var _a;
        var children = isArr(item.children)
...
var InternalSelectTable = observer(function (props) {
    ...
    var _g = __read(useStyle(prefixCls), 2), wrapSSR = _g[0], hashId = _g[1];
    ...
    var _j = useSize((_a = field.decoratorProps) === null || _a === void 0 ? void 0 : _a.size, searchProps === null || searchProps === void 0 ? void 0 : searchProps.size, props === null || props === void 0 ? void 0 : props.size), searchSize = _j.searchSize, tableSize = _j.tableSize;
    var primaryKey = isFn(rowKey) ? '__formily_key__' : rowKey;
    var sources = useSources();
    var columns = useColumns(sources);
    // dataSource
    var dataSource = isArr(propsDataSource) ? propsDataSource : field.dataSource;
    ...
    var orderedFilteredDataSource = useMemo(function () {
        if (!filterSort) {
    ...
    return wrapSSR(React.createElement("div", { className: cls(prefixCls, hashId) },
        showSearch ? (React.createElement(Search, __assign({}, searchProps, { className: cls("".concat(prefixCls, "-search"), searchProps === null || searchProps === void 0 ? void 0 : searchProps.className), style: __assign({ width: '100%' }, searchProps === null || searchProps === void 0 ? void 0 : searchProps.style), onSearch: onInnerSearch, onChange: function (e) { return onInnerSearch(e.target.value); }, disabled: disabled, readOnly: readOnly, size: searchSize, loading: loading }))) : null,
        React.createElement(Table, __assign({}, otherTableProps, { className: cls("".concat(prefixCls, "-table"), className), dataSource: readPretty ? readPrettyDataSource : orderedFilteredDataSource, rowSelection: readPretty
                ? undefined
...
export var SelectTable = Object.assign(InternalSelectTable, {
    Column: TableColumn,
});
