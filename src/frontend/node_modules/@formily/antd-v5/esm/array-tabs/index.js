...
var FeedbackBadge = observer(function (props) {
    ...
    if (errors.length) {
        return (React.createElement(Badge, { size: "small", className: "errors-badge", count: errors.length }, tab));
    }
...
export var ArrayTabs = observer(function (props) {
    ...
    return (React.createElement(Tabs, __assign({}, props, { activeKey: activeKey, onChange: function (key) {
            setActiveKey(key);
            ...
            return {
                key: key,
                label: React.createElement(FeedbackBadge, { index: index }),
                forceRender: true,
                closable: index !== 0,
                children: items ? (React.createElement(RecursionField, { schema: items, name: index })) : null,
            };
        }) })));
});
