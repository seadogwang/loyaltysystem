...
export function FormDrawer(title, id, renderer) {
    ...
    var drawer = __assign(__assign({ width: '40%' }, props), { onClose: function (e) {
            var _a;
    ...
    var DrawerContent = observer(function () {
        return React.createElement(Fragment, null, isFn(renderer) ? renderer(env.form) : renderer);
    });
    var renderDrawer = function (open) {
        ...
        if (!form)
            return null;
        return (React.createElement(Drawer, __assign({}, drawer, { open: open }),
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            env.form =
                                env.form ||
                                    createForm(__assign(__assign({}, props), { effects: function (form) {
                                            var _a;
...
var DrawerExtra = function (props) {
    var ref = useRef(null);
    var _a = __read(useState(), 2), extra = _a[0], setExtra = _a[1];
    var extraRef = useRef();
    ...
    return (React.createElement("div", { ref: ref, style: { display: 'none' } }, extra && createPortal(props.children, extra)));
};
