...
var InternalEditable = observer(function (props) {
    ...
    var renderEditHelper = function () {
        if (editable)
            return;
        return (React.createElement(BaseItem, __assign({}, props, itemProps),
            pattern === 'editable' && (React.createElement(EditOutlined, { className: "".concat(prefixCls, "-edit-btn") })),
            pattern !== 'editable' && (React.createElement(MessageOutlined, { className: "".concat(prefixCls, "-edit-btn") }))));
    };
    var renderCloseHelper = function () {
        if (!editable)
            return;
        return (React.createElement(BaseItem, __assign({}, props),
            React.createElement(CloseOutlined, { className: "".concat(prefixCls, "-close-btn") })));
    };
    ...
    return wrapSSR(React.createElement("div", { className: cls(prefixCls, hashId), ref: innerRef, onClick: onClick },
        React.createElement("div", { className: "".concat(prefixCls, "-content") },
            React.createElement(BaseItem, __assign({}, props, itemProps), props.children),
            renderEditHelper(),
            renderCloseHelper())));
});
var Popover = observer(function (props) {
    ...
    return wrapSSR(React.createElement(AntdPopover, __assign({}, props, { title: props.title || field.title, open: open, className: cls(prefixCls, hashId, props.className), content: props.children, trigger: "click", destroyTooltipOnHide: true, onOpenChange: function (open) {
            if (open) {
                openPopover();
            }
            else {
...
export var Editable = Object.assign(InternalEditable, { Popover: Popover });
