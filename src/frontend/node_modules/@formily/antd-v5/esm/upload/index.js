...
export var Upload = connect(function (props) {
    return (React.createElement(AntdUpload, __assign({}, useUploadProps(props)), props.children || getPlaceholder(props)));
}, mapProps({
    value: 'fileList',
}));
var Dragger = connect(function (props) {
    return (React.createElement("div", { className: usePrefixCls('upload-dragger') },
        React.createElement(AntdUpload.Dragger, __assign({}, useUploadProps(props)), props.children || (React.createElement(React.Fragment, null,
            React.createElement("p", { className: "ant-upload-drag-icon" },
                React.createElement(InboxOutlined, null)),
            props.textContent && (React.createElement("p", { className: "ant-upload-text" }, props.textContent)))))));
}, mapProps({
    value: 'fileList',
}));
