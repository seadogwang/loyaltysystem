...
var InternalFormCollapse = observer(function (_a) {
    ...
    var badgedHeader = function (key, props) {
        ...
        if (errors.length) {
            return (React.createElement(Badge, { size: "small", className: "errors-badge", count: errors.length }, props.header));
        }
        return props.header;
    };
    return (React.createElement(Collapse, __assign({}, props, { className: cls(prefixCls, props.className), activeKey: takeActiveKeys(), onChange: function (key) {
            var _a, _b;
        ...
        return (React.createElement(Collapse.Panel, __assign({ key: index }, props, { header: badgedHeader(name, props), forceRender: true }),
...
export var FormCollapse = Object.assign(InternalFormCollapse, {
