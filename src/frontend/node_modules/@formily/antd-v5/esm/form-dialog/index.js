...
export function FormDialog(title, id, renderer) {
    ...
    var renderDialog = function (open, resolve, reject) {
        ...
        if (!form)
            return null;
        return (React.createElement(Observer, null, function () { return (React.createElement(Modal, __assign({}, modal, { open: open, confirmLoading: form.submitting, onCancel: function (e) {
                var _a;
