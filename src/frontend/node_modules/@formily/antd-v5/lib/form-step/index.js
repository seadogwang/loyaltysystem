...
var createFormStep = function (defaultCurrent) {
    ...
    var env = (0, reactive_1.define)({
        form: null,
        field: null,
        steps: [],
    }, {
        form: reactive_1.observable.ref,
        field: reactive_1.observable.ref,
        steps: reactive_1.observable.shallow,
    });
...
exports.FormStep = (0, react_1.connect)((0, react_1.observer)(function (_a) {
    var _b;
    ...
    return (react_2.default.createElement("div", { className: (0, classnames_1.default)(prefixCls, className) },
        react_2.default.createElement(antd_1.Steps, __assign({}, props, { style: __assign({ marginBottom: 10 }, props.style), current: current }), steps.map(function (_a, key) {
            var props = _a.props;
            return react_2.default.createElement(antd_1.Steps.Step, __assign({}, props, { key: key }));
        })),
        steps.map(function (_a, key) {
            var name = _a.name, schema = _a.schema;
            if (key !== current)
                return;
            return react_2.default.createElement(react_1.RecursionField, { key: key, name: name, schema: schema });
        })));
}));
