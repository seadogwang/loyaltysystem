...
var useTabs = function () {
    var tabsField = (0, react_1.useField)();
    ...
    schema.mapProperties(function (schema, name) {
        ...
        if (((_a = schema['x-component']) === null || _a === void 0 ? void 0 : _a.indexOf('TabPane')) > -1) {
            ...
            tabs.push({
                name: name,
                props: __assign(__assign(__assign({}, schema === null || schema === void 0 ? void 0 : schema['x-component-props']), field === null || field === void 0 ? void 0 : field.componentProps), { key: key }),
                schema: schema,
            });
        }
    });
...
var FeedbackBadge = (0, react_1.observer)(function (props) {
    ...
    if (errors.length) {
        return (react_2.default.createElement(antd_1.Badge, { size: "small", className: "errors-badge", count: errors.length }, props.tab));
    }
    return react_2.default.createElement(react_2.Fragment, null, props.tab);
});
...
exports.FormTab = (0, react_1.observer)(function (_a) {
    var formTab = _a.formTab, props = __rest(_a, ["formTab"]);
    var tabs = useTabs();
    var _formTab = (0, react_2.useMemo)(function () {
    ...
    return (react_2.default.createElement(antd_1.Tabs, __assign({}, props, { className: (0, classnames_1.default)(prefixCls, props.className), activeKey: activeKey, onChange: function (key) {
            var _a, _b;
            ...
            return __assign(__assign({ key: key, label: react_2.default.createElement(FeedbackBadge, { name: name, tab: props.tab }) }, props), { children: react_2.default.createElement(react_1.RecursionField, { schema: schema, name: name }) });
        }) })));
});
var TabPane = function (_a) {
    var children = _a.children;
    return react_2.default.createElement(react_2.Fragment, null, children);
};
