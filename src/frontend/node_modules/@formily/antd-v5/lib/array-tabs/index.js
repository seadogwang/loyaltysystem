...
var FeedbackBadge = (0, react_1.observer)(function (props) {
    ...
    if (errors.length) {
        return (react_2.default.createElement(antd_1.Badge, { size: "small", className: "errors-badge", count: errors.length }, tab));
    }
    return react_2.default.createElement(react_2.Fragment, null, tab);
});
exports.ArrayTabs = (0, react_1.observer)(function (props) {
    var field = (0, react_1.useField)();
    var schema = (0, react_1.useFieldSchema)();
    var _a = __read((0, react_2.useState)('tab-0'), 2), activeKey = _a[0], setActiveKey = _a[1];
    ...
    return (react_2.default.createElement(antd_1.Tabs, __assign({}, props, { activeKey: activeKey, onChange: function (key) {
            setActiveKey(key);
            ...
            return {
                key: key,
                label: react_2.default.createElement(FeedbackBadge, { index: index }),
                forceRender: true,
                closable: index !== 0,
                children: items ? (react_2.default.createElement(react_1.RecursionField, { schema: items, name: index })) : null,
            };
        }) })));
});
