...
var getImageByUrl = function (url, options) {
    for (var i = 0; i < placeholder_1.UPLOAD_PLACEHOLDER.length; i++) {
        if (placeholder_1.UPLOAD_PLACEHOLDER[i].ext.test(url) &&
...
var normalizeFileList = function (fileList) {
    if (fileList && fileList.length) {
        return fileList.map(function (file, index) {
            return __assign(__assign({}, file), { uid: file.uid || "".concat(index), status: getState(file.response) || getState(file), url: getURL(file) || getURL(file === null || file === void 0 ? void 0 : file.response), thumbUrl: getImageByUrl(getThumbURL(file) || getThumbURL(file === null || file === void 0 ? void 0 : file.response), {
                    exclude: [
                        '.png',
                        '.jpg',
                        '.jpeg',
...
var useValidator = function (validator) {
    ...
    (0, react_1.useEffect)(function () {
        var dispose = (0, reactive_1.reaction)(function () { return field.value; }, function (value) {
...
function useUploadProps(_a) {
    ...
    var onChange = function (param) {
        var _a;
        (_a = props.onChange) === null || _a === void 0 ? void 0 : _a.call(props, normalizeFileList(__spreadArray([], __read(param.fileList), false)));
    };
    return __assign(__assign({}, props), { fileList: normalizeFileList(props.fileList), onChange: onChange });
}
...
exports.Upload = (0, react_2.connect)(function (props) {
    return (react_1.default.createElement(antd_1.Upload, __assign({}, useUploadProps(props)), props.children || getPlaceholder(props)));
}, (0, react_2.mapProps)({
    value: 'fileList',
}));
var Dragger = (0, react_2.connect)(function (props) {
    return (react_1.default.createElement("div", { className: (0, __builtins__1.usePrefixCls)('upload-dragger') },
        react_1.default.createElement(antd_1.Upload.Dragger, __assign({}, useUploadProps(props)), props.children || (react_1.default.createElement(react_1.default.Fragment, null,
            react_1.default.createElement("p", { className: "ant-upload-drag-icon" },
                react_1.default.createElement(icons_1.InboxOutlined, null)),
            props.textContent && (react_1.default.createElement("p", { className: "ant-upload-text" }, props.textContent)))))));
}, (0, react_2.mapProps)({
    value: 'fileList',
}));
