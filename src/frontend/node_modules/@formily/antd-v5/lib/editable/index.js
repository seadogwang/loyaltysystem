...
var InternalEditable = (0, react_1.observer)(function (props) {
    var _a = __read(useEditable(), 2), editable = _a[0], setEditable = _a[1];
    var pattern = useParentPattern();
    ...
    var renderEditHelper = function () {
        if (editable)
            return;
        return (react_2.default.createElement(form_item_1.BaseItem, __assign({}, props, itemProps),
            pattern === 'editable' && (react_2.default.createElement(icons_1.EditOutlined, { className: "".concat(prefixCls, "-edit-btn") })),
            pattern !== 'editable' && (react_2.default.createElement(icons_1.MessageOutlined, { className: "".concat(prefixCls, "-edit-btn") }))));
    };
    var renderCloseHelper = function () {
        if (!editable)
            return;
        return (react_2.default.createElement(form_item_1.BaseItem, __assign({}, props),
            react_2.default.createElement(icons_1.CloseOutlined, { className: "".concat(prefixCls, "-close-btn") })));
    };
    ...
    return wrapSSR(react_2.default.createElement("div", { className: (0, classnames_1.default)(prefixCls, hashId), ref: innerRef, onClick: onClick },
        react_2.default.createElement("div", { className: "".concat(prefixCls, "-content") },
            react_2.default.createElement(form_item_1.BaseItem, __assign({}, props, itemProps), props.children),
            renderEditHelper(),
            renderCloseHelper())));
});
var Popover = (0, react_1.observer)(function (props) {
    var field = (0, react_1.useField)();
    var pattern = useParentPattern();
    var _a = __read((0, react_2.useState)(false), 2), open = _a[0], setOpen = _a[1];
    var prefixCls = (0, __builtins__1.usePrefixCls)('formily-editable');
    var _b = __read((0, style_1.default)(prefixCls), 2), wrapSSR = _b[0], hashId = _b[1];
    ...
    return wrapSSR(react_2.default.createElement(antd_1.Popover, __assign({}, props, { title: props.title || field.title, open: open, className: (0, classnames_1.default)(prefixCls, hashId, props.className), content: props.children, trigger: "click", destroyTooltipOnHide: true, onOpenChange: function (open) {
            if (open) {
                openPopover();
            }
            else {
        ...
        react_2.default.createElement("div", null,
            react_2.default.createElement(form_item_1.BaseItem, { className: "".concat(prefixCls, "-trigger") },
                react_2.default.createElement("div", { className: "".concat(prefixCls, "-content") },
                    react_2.default.createElement("span", { className: "".concat(prefixCls, "-preview") }, props.title || field.title),
                    pattern === 'editable' && (react_2.default.createElement(icons_1.EditOutlined, { className: "".concat(prefixCls, "-edit-btn") })),
                    pattern !== 'editable' && (react_2.default.createElement(icons_1.MessageOutlined, { className: "".concat(prefixCls, "-edit-btn") })))))));
});
exports.Editable = Object.assign(InternalEditable, { Popover: Popover });
