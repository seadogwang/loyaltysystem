...
var usePanels = function () {
    var collapseField = (0, react_1.useField)();
...
var InternalFormCollapse = (0, react_1.observer)(function (_a) {
    ...
    var _formCollapse = (0, react_2.useMemo)(function () {
        return formCollapse
            ? formCollapse
    ...
    var badgedHeader = function (key, props) {
        ...
        if (errors.length) {
            return (react_2.default.createElement(antd_1.Badge, { size: "small", className: "errors-badge", count: errors.length }, props.header));
        }
        return props.header;
    };
    return (react_2.default.createElement(antd_1.Collapse, __assign({}, props, { className: (0, classnames_1.default)(prefixCls, props.className), activeKey: takeActiveKeys(), onChange: function (key) {
            var _a, _b;
        ...
        return (react_2.default.createElement(antd_1.Collapse.Panel, __assign({ key: index }, props, { header: badgedHeader(name, props), forceRender: true }),
            react_2.default.createElement(react_1.RecursionField, { schema: schema, name: name })));
    })));
});
...
exports.FormCollapse = Object.assign(InternalFormCollapse, {
