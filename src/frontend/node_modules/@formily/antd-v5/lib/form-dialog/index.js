...
var isModalTitle = function (props) {
    return ((0, shared_1.isNum)(props) || (0, shared_1.isStr)(props) || (0, shared_1.isBool)(props) || react_2.default.isValidElement(props));
};
...
function FormDialog(title, id, renderer) {
    var _this = this;
    if ((0, shared_1.isFn)(id) || react_2.default.isValidElement(id)) {
        renderer = id;
        id = 'form-dialog';
    }
    var env = {
    ...
    var DialogContent = (0, react_1.observer)(function () {
        return react_2.default.createElement(react_2.Fragment, null, (0, shared_1.isFn)(renderer) ? renderer(env.form) : renderer);
    });
    var renderDialog = function (open, resolve, reject) {
        ...
        if (!form)
            return null;
        return (react_2.default.createElement(react_1.Observer, null, function () { return (react_2.default.createElement(antd_1.Modal, __assign({}, modal, { open: open, confirmLoading: form.submitting, onCancel: function (e) {
                var _a;
            ...
            react_2.default.createElement(react_1.FormProvider, { form: form },
                react_2.default.createElement(DialogContent, null)))); }));
    };
...
var DialogFooter = function (props) {
    ...
    var _a = __read((0, react_2.useState)(), 2), footer = _a[0], setFooter = _a[1];
    var footerRef = (0, react_2.useRef)();
    var prefixCls = (0, __builtins__1.usePrefixCls)('modal');
    ...
    return (react_2.default.createElement("div", { ref: ref, style: { display: 'none' } }, footer && (0, react_dom_1.createPortal)(props.children, footer)));
};
