    ...
    return function () {
        ...
        var onInnerChange = function (e) {
            if (!readOnly) {
                ...
                if ((0, utils_1.getCompatibleAllSelected)(selected, flatFilteredDataSource, usableKeys_1, checkStrictly, primaryKey)) {
                    isSelected = false;
                }
                var newSelected = [];
                if (isSelected) {
        ...
        return (react_1.default.createElement(antd_1.Checkbox, { key: "titleAddons", disabled: disabled, checked: checked, indeterminate: indeterminate, onChange: onInnerChange }));
    };
};
...
exports.useTitleAddon = useTitleAddon;
