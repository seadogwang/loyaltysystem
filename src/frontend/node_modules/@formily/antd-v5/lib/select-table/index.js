...
var InternalSelectTable = (0, react_1.observer)(function (props) {
    var _a, _b;
    var _c = props.mode, mode = _c === void 0 ? 'multiple' : _c, propsDataSource = props.dataSource, optionAsValue = props.optionAsValue, _d = props.valueType, valueType = _d === void 0 ? 'all' : _d, _e = props.showSearch, showSearch = _e === void 0 ? false : _e, filterOption = props.filterOption, filterSort = props.filterSort, onSearch = props.onSearch, searchProps = props.searchProps, className = props.className, value = props.value, onChange = props.onChange, rowSelection = props.rowSelection, _f = props.primaryKey, rowKey = _f === void 0 ? 'key' : _f, otherTableProps = __rest(props, ["mode", "dataSource", "optionAsValue", "valueType", "showSearch", "filterOption", "filterSort", "onSearch", "searchProps", "className", "value", "onChange", "rowSelection", "primaryKey"]);
    var prefixCls = (0, __builtins__1.usePrefixCls)('formily-select-table', props);
    var _g = __read((0, style_1.default)(prefixCls), 2), wrapSSR = _g[0], hashId = _g[1];
    var _h = __read((0, react_2.useState)(), 2), searchValue = _h[0], setSearchValue = _h[1];
    ...
    var _j = (0, hooks_1.useSize)((_a = field.decoratorProps) === null || _a === void 0 ? void 0 : _a.size, searchProps === null || searchProps === void 0 ? void 0 : searchProps.size, props === null || props === void 0 ? void 0 : props.size), searchSize = _j.searchSize, tableSize = _j.tableSize;
    ...
    var filteredDataSource = (0, hooks_1.useFilterOptions)(dataSource, searchValue, filterOption, rowSelection === null || rowSelection === void 0 ? void 0 : rowSelection.checkStrictly);
    // Order dataSource By filterSort
    var orderedFilteredDataSource = (0, react_2.useMemo)(function () {
        if (!filterSort) {
    ...
    var flatDataSource = (0, hooks_1.useFlatOptions)(dataSource);
    var flatFilteredDataSource = (0, hooks_1.useFlatOptions)(filteredDataSource);
    ...
    // readPretty Value
    var readPrettyDataSource = (0, hooks_1.useFilterOptions)(orderedFilteredDataSource, selected, function (value, item) { return primaryKey && value.includes(item[primaryKey]); });
    ...
    var onSlacklyChange = function (currentSelected) {
        var selectedRowKeys = (0, hooks_1.useCheckSlackly)(currentSelected, selected, flatDataSource, flatFilteredDataSource, primaryKey, rowSelection === null || rowSelection === void 0 ? void 0 : rowSelection.checkStrictly).selectedRowKeys;
        onInnerChange(selectedRowKeys);
    };
    // Table All Checkbox
    var titleAddon = (0, hooks_1.useTitleAddon)(selected, flatDataSource, flatFilteredDataSource, primaryKey, mode, disabled, readOnly, rowSelection === null || rowSelection === void 0 ? void 0 : rowSelection.checkStrictly, onInnerChange);
    // Antd rowSelection type
    var modeAsType = (_b = { multiple: 'checkbox', single: 'radio' }) === null || _b === void 0 ? void 0 : _b[mode || ''];
    return wrapSSR(react_2.default.createElement("div", { className: (0, classnames_1.default)(prefixCls, hashId) },
        showSearch ? (react_2.default.createElement(Search, __assign({}, searchProps, { className: (0, classnames_1.default)("".concat(prefixCls, "-search"), searchProps === null || searchProps === void 0 ? void 0 : searchProps.className), style: __assign({ width: '100%' }, searchProps === null || searchProps === void 0 ? void 0 : searchProps.style), onSearch: onInnerSearch, onChange: function (e) { return onInnerSearch(e.target.value); }, disabled: disabled, readOnly: readOnly, size: searchSize, loading: loading }))) : null,
        react_2.default.createElement(antd_1.Table, __assign({}, otherTableProps, { className: (0, classnames_1.default)("".concat(prefixCls, "-table"), className), dataSource: readPretty ? readPrettyDataSource : orderedFilteredDataSource, rowSelection: readPretty
                ? undefined
                : __assign(__assign(__assign(__assign(__assign({}, rowSelection), titleAddon), { getCheckboxProps: function (record) {
                        var _a;
                        return (__assign(__assign({}, (_a = rowSelection === null || rowSelection === void 0 ? void 0 : rowSelection.getCheckboxProps) === null || _a === void 0 ? void 0 : _a.call(rowSelection, record)), { disabled: disabled || (record === null || record === void 0 ? void 0 : record.disabled) }));
                    ...
                    : {
                        renderCell: function (checked, record, index, originNode) {
                            return react_2.default.cloneElement(originNode, {
                                indeterminate: (0, hooks_1.getIndeterminate)(record, flatDataSource, selected, primaryKey),
                            });
                        },
                ...
                return __assign(__assign({}, onRowResult), { onClick: function (e) {
                        var _a;
...
var TableColumn = function () { return react_2.default.createElement(react_2.default.Fragment, null); };
exports.SelectTable = Object.assign(InternalSelectTable, {
    Column: TableColumn,
});
