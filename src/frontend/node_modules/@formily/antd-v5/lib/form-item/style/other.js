        ...
        _a[componentCls] = (_b = {
                ...
                '&-warning': (_e = {},
                    ...
                    _e["".concat(antCls, "-select:not(").concat(antCls, "-select-disabled):not(").concat(antCls, "-select-customize-input)")] = (_f = {},
                        ...
                        _f["&".concat(antCls, "-select-open ").concat(antCls, "-select-selector,\n              &").concat(antCls, "-select-focused ").concat(antCls, "-select-selector")] = __assign({}, active(colorWarning, colorWarningOutline)),
                        _f),
                    _e["".concat(antCls, "-input-number,\n          ").concat(antCls, "-picker")] = (_g = {
                            backgroundColor: colorWarningBg,
                            borderColor: colorWarning
                        },
                        _g["&-focused,\n            &:focus"] = __assign({}, active(colorWarning, colorWarningOutline)),
                        _g['&:not([disabled]):hover'] = {
                            backgroundColor: colorWarningBg,
                            borderColor: colorWarning,
                        },
                        _g),
                    _e["".concat(antCls, "-cascader-picker:focus ").concat(antCls, "-cascader-input")] = __assign({ backgroundColor: colorWarningBg }, active(colorWarning, colorWarningOutline)),
                    _e["".concat(antCls, "-input-affix-wrapper-focused,\n          ").concat(antCls, "-input-affix-wrapper:focus,\n          ").concat(antCls, "-input-focused,\n          ").concat(antCls, "-input:focus")] = __assign({}, active(colorWarning, colorWarningOutline)),
                    _e),
                '&-error': (_h = {},
                    ...
                    _h["".concat(antCls, "-select:not(").concat(antCls, "-select-disabled):not(").concat(antCls, "-select-customize-input)")] = (_j = {},
                        ...
                        _j["&".concat(antCls, "-select-open ").concat(antCls, "-select-selector,\n                &").concat(antCls, "-select-focused ").concat(antCls, "-select-selector")] = __assign({}, active(colorError, colorErrorOutline)),
                        _j),
                    _h["".concat(antCls, "-input-number,\n            ").concat(antCls, "-picker")] = (_k = {
                            borderColor: colorError
                        },
                        _k["&-focused,\n            &:focus"] = __assign({}, active(colorError, colorErrorOutline)),
                        _k["&:not([disabled]):hover"] = {
                            borderColor: colorError,
                        },
                        _k),
                    _h["".concat(antCls, "-cascader-picker:focus ").concat(antCls, "-cascader-input")] = __assign({}, active(colorError, colorErrorOutline)),
                    _h["".concat(antCls, "-input-affix-wrapper-focused,\n            ").concat(antCls, "-input-affix-wrapper:focus,\n            ").concat(antCls, "-input-focused,\n            ").concat(antCls, "-input:focus")] = __assign({}, active(colorError, colorErrorOutline)),
                    _h),
                '&-feedback-layout': {
                    '&-terse': (_l = {
                ...
                '&-inset': (_v = {
                    ...
                    _v["".concat(antCls, "-input-number-handler-wrap")] = (_w = {
                        ...
                        _w),
                    _v['&:hover'] = __assign({}, hover()),
                    _v),
                '&-active': (_x = {},
                    _x["".concat(componentCls, "-control-content-component-has-feedback-icon")] = __assign({}, active()),
                    _x["".concat(antCls, "-input-number,\n          ").concat(antCls, "-picker,\n          ").concat(antCls, "-cascader-picker:focus ").concat(antCls, "-cascader-input,\n          ").concat(antCls, "-select:not(").concat(antCls, "-select-customize-input)\n          ").concat(antCls, "-select-selector,\n          ").concat(antCls, "-input")] = __assign({}, active()),
                    _x),
                '&-inset-active': __assign({}, active()),
                '&-bordered-none': (_y = {},
                    ...
                    _y),
                '&:hover': (_0 = {},
                    _0["".concat(componentCls, "-control-content-component-has-feedback-icon")] = __assign({}, hover()),
                    _0)
            },
...
exports.genOtherStyle = genOtherStyle;
