...
exports.default = (0, __builtins__1.genStyleHook)('Form', function (token) {
    return [
        genFormItemStyle(token),
        (0, animation_1.getAnimationStyle)(token),
        (0, other_1.genOtherStyle)(token),
        (0, grid_1.getGridStyle)(token),
    ];
});
